...
NODES = [
    ...
    ("rotation/engine_power", "rotation/torque_5", "goal", "@bronze_engine", "Ignition", "yellow",
    ...
    ("rotation/chain_loop", "rotation/first_power", "goal", "minecraft:chain", "Closing the Loop", "yellow",
    ...
    ("structures/drawbridge", "structures/assemble", "goal", "@rotator_side", "Lower the Drawbridge", "yellow",
